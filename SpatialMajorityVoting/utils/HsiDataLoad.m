...
if (strcmp(data_name,'PaviaCenter'))
    spectral_data=load('data\Pavia.mat');    
    gt_data=load('data\Pavia_gt.mat');
...
elseif (strcmp(data_name,'PaviaUniv'))
    spectral_data=load('data\PaviaU.mat');
    gt_data=load('data\PaviaU_gt.mat');
...
elseif (strcmp(data_name,'IndianPine'))
    spectral_data=load('data\Indian_pines_corrected.mat');
    gt_data=load('data\Indian_pines_gt.mat');
